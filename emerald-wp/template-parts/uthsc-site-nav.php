        ...
        <ul class="dropdown menu" data-dropdown-menu="data-dropdown-menu">
            <li class="has-submenu">
                ...
                <ul class="submenu menu vertical" data-submenu="data-submenu">
                    <li>
                        <a href="http://uthsc.edu/education/">
                    ...
                    <li>
                        <a href="http://uthsc.edu/clinicalcare/">
                            <span aria-hidden="true" class="fa fa-medkit"></span>
                            Clinical Care
                        </a>
                    </li>
                    <li>
                        <a href="http://uthsc.edu/publicservice/">
                            <span aria-hidden="true" class="fa fa-globe"></span>
                            Public Service
                        </a>
                    </li>
                    <li>
                        <a href="http://uthsc.edu/aboututhsc/utmission.php">
                            Mission Statement
                        </a>
                    </li>
                </ul>
            ...
            <li><a href="http://uthsc.edu/give/"><span aria-hidden="true" class="fa fa-gift"></span> Make a Gift</a></li>
            <li><a href="http://uthsc.edu/admissions/visit-uthsc.php"><span aria-hidden="true" class="fa fa-road"></span> Take a Tour</a></li>
            <li role="menuitem">
